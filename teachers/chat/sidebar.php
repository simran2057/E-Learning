  <!-- start sidebar -->
  <div id="sideBar" class=" h-full relative flex flex-col flex-wrap -mt-40 p-6  w-64 bg-white md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster shadow-md rounded-lg">
    ...
    <div class="flex flex-col">
      ...
      <hr>
      <!-- link -->
      <a href="../../teachers/tdashboard.php" class=" capitalize font-medium text-base hover:text-teal-600 transition ease-in-out duration-500">
      ...
      <!-- link -->
      <a href="chat/chat.php" class="mb-3 p-1 capitalize font-medium text-base hover:text-teal-600 transition ease-in-out duration-500">
