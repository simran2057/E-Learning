    ...
    <div class="w-2/3 border-l">
      <div class="form-wrapper flex items-center lg:h-full px-10 relative z-10 pt-16 lg:pt-0 shadow-lg rounded-lg">
        <div class="w-full space-y-5">
          ...
          <form class="user" action="process/stdloginpage.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-element">
              <div class="w-full lg:w-4/5  mx-auto pt-2 flex items-center justify-between">
                ...
                <a href="pswdindex.php" class=" text-gray-800 tracking-wide inline-block border-b border-gray-300 mt-4">Forgot Password?</a>
              </div>
            </div>
            <!-- form element -->
